...
```shell
root@host3:~# kubectl expose pod/kubernetes-bootcamp --type="NodePort" --port 8080
...
执行minikube ip 查看IP地址

```shell
root@host3:~# minikube ip
192.168.49.2
```
...
```shell
root@host3:~# curl 192.168.49.2:30322
